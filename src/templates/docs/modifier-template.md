...
>
> **Masquerade/secret identity notes:** (Notes for secret identity & masquerade authorship, like if this modifier is intended to be custom-masquerade-only or what secret identities should roll this modifier more often, if applicable. N/A otherwise)
>
...
Outline how differing secret identity rolls can affect the intrigue of this modifier, and how it introduces ambiguity into interactions that might otherwise have none.
