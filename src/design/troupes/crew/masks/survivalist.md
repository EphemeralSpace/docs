...
The Survivalist is a very simple mask that mostly creates intrigue around themselves through their medical alerts, while also being a generic layer of protection they can rely on and make decisions around.
...
This is intentionally a very low-impact mask, and the intent is that the Survivalist is mostly a strongly crew-sided helpful mask with an ability that's helpful in a pinch.
