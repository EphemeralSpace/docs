...
Alongside the offer, the Godfather also selects a target for the member to attack in a show of loyalty.

If the player accepts the offer, they will lose their current mask and become a [goon]().
...
Instead, goons have a mask objective to crit out the target that the Godfather specified.
