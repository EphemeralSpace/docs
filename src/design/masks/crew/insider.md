...
>
> *Got a big new scoop for you. Word around town is the fella with grey hair and an M and X in his name is some kinda crazy evil-doing revolutionary.*

```admonish warning "Notes"
Possible we'll have to rework crew manifest stuff and what not to make this a little bit harder of a process and require walking around to find names and appearances and shit. Idk we'll see.
The "clues" mechanic should be very generic and usable for many other things in the future, same as how it is for the Enthraller, which I want to use the same thing more or less.
```
