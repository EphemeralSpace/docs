...
- **Sabotagers** have objectives which revolve around engaging in some kind of malicious activity that generally harms others and leads to direct conflict and has deniability with organization secret identities. Examples: [rebel](secret-identities/crew/rebel.md).
