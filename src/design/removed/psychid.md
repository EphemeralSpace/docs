...
{{#template ../../templates/removed-implemented.md reason="Not super disruptive but generally just unreasonably difficult to counter. Since any kill guarantees a conversion, there's no feasible way to remove them from the round short of just locking them inside a 1x1 box. Even though killing parasites is intentionally discouraged, their effects need some form of mitigation, otherwise, there's just nothing you can do about them, even when identified."}}
