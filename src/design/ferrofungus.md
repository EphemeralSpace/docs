...
The Ferrofungus interacts with all three vectors of station decay in unique ways. Filth nourishes the Ferrofungus, speeding its growth up greatly when growing into a Filth filled area. Fungal Creep generates water vapor when it meets fluids, creating the conditions for rust. Fire, on the other hand, is anathema to the highly flammable Ferrofungus, but wildly setting it on fire in the hopes of getting rid of it can have an equally detrimental effect to the station as having let it spread.
