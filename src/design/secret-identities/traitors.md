...
Traitors are a organization of secret identities focused on utilizing subterfuge to further their objectives.
Although every traitor secret identity receives a unique set of equipment, their primary strength is their ability to identify each other and work together to accomplish their objectives.
...
## Equipment
To assist in completing their objectives, all traitors are told of the location of a hidden item cache in maintenance, containing illicit equipment related that varies depending on their secret identity.
For example, one secret identity might get a gun and some ammo, while one another might get a chameleon kit, voice secret identity, and agent ID.
...
All players in the traitor organization, regardless of secret identity type, share a pool of objectives.
...
From a game design perspective, the towers are meant to serve as a sort of generic gameplay macguffin for any organization objective that needs some kind of limiting mechanic. The nuke disk pinpointing functionality also makes them more valuable as key "control points" and gives them a reason to exist besides being hacked.
