...
## Concept
The eavesdropper is a secret identity who can select a target to begin "eavesdropping on them."
...
This creates a much more tightly-knit guardian secret identity than something like the [avenger](avenger.md), as the two are always in contact and able to exchange information.
