...
The Phantom is a jester-type secret identity. They want to be killed, whereupon they will be revived as a vengeful phantom that must annoy the hell out of their murderer in indirect ways, in hopes they will eventually die as a result.
...
As a jester-type secret identity, the Phantom disincentivizes random murder without cause. It also provides ambiguity for other jester-type secret identities like the [parasites](../parasites.md).
...
The vengeful phantom is equivalent to a Ghost ghost-role (if we get those, emo knows what I mean) in scope and abilities, but it still has a secret identity and the objectives of a Phantom.
