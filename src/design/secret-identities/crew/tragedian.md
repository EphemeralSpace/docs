...
## Concept
The Tragedian is a crew secret identity whose success directly depends on the opinion of the stagehands.
...
The objectivity of the completion gives the secret identity a unique niche, allowing the encouragement of more ineffable objectives which are up to the stagehands to determine.
