...
> **Name:** Leapleech
>
> **Organization:** [Parasite](../parasites.md)
>
...
## Concept
The leapleech is a parasite secret identity that is focused on being injured by other people in order to grow in strength.
...
Upon death, the secret identity will explode into a cluster of individual leapleech parasites.
...
## Gameplay
The leapleech incorporates many elements of the removed daredevil secret identity to create a jester which does not necessarily appear as one.
Since their ability is something which necessitates a lot of buildup and combat, the secret identity differentiates itself from the other parasites by an initial aversion to death.
...
This adds an extra dimension to the secret identity's planning, since they'll likely want to perish in a location where their leech nest can attack and prey on unsuspecting passerby.
