...
## Gameplay
As a gameplay element, the secret identity creates a situation where a player must mastermind a general challenge for the crew which they are doomed to fail.
