...
```admonish warning
this is a reimagining of the old "psychid" secret identity, which is still ingame, while this isn't atm.
```
...
The Corpsychid is a parasite secret identity oriented around hijacking dead bodies (including their own), reanimating them and forcing them to semi-aggressively amble around before bursting into spores after being attacked.
