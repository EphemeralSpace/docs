...
When the secret identity is killed, each node creates a moving stream of barnacles in the direction of the body.
...
This encourages a level of nest-building, a distinguishing factor for the secret identity that gives it a unique dynamic.
