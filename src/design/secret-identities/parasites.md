...
Parasites are a **major organization** focused on jester-type gameplay and taking advantage of people's violent nature.
...
The dynamic of the organization lies in this balance; can the crew stop themselves from devolving into violence and death, even as the parasites slowly infect and turn them against each other.

The organization itself is a bit of a boogeyman: once the infection starts to spread, there's no question that you're dealing with parasites.
...
In an uninfected host, this prompts the parasites to attempt to infect the killer and brainwash them, converting them into a parasite secret identity.
...
While the specific form the parasite takes outside the body varies from secret identity to secret identity, they all share the general form of a small, weak, parasitic worm.
Seeing these worms emerge from a body or just amble around the station serves as a strong indication of the organization's presence on the station.

Once a parasite secret identity infects someone else, be it through some small pest or any other conversion method, the victim will gain the same secret identity as the one who infected them.
This creates a general "presence" which serves to counteract the knowledge barrier and obscurity of conversions.
If a single burstworm infects a crowd of people, more will be on the way and accounting for that becomes an important element of counteracting the organization.
...
The goal is that, depending on the needs of their secret identity, the parasite can manipulate their metabolism to die at the most opportune time.

## Worm Domination
Once the parasites have infected the majority of the station, they have (effectively) won and enter their final phase.
This serves as a narrative climax to the round rather than a gate to the organization winning.
