...
## Concept
The Syndicate Sympathizer is a member of the traitor organization who is isolated and unable to directly cooperate with other traitors.
They do not appear as traitors to other traitors nor are the able to see the organization icon on others.

Sympathizers cannot see which objectives the traitors have, although they have an objective that tracks the completion of the traitor organization objectives.
...
## Gameplay
The Syndicate Sympathizer is a secret identity which introduces potential malice in what might otherwise be assumed to be incompetence.
