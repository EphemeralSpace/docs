...
While events should create a momentary pause in typical gameplay, they shouldn't be massively disrupting the round to the point where the main gameplay of [secret identities](secret identities.md) is sidelined.
